...
Public NotInheritable Class frmAbout
    Private Sub frmAbout_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        ...
        sStr2 =
            "Предназначена для контрольного суммирования, проведения инспекционного контроля, контроля целостности и отслеживания изменений версий программных продуктов." & vbCrLf & vbCrLf & "Что может прогамма:" & vbCrLf & vbCrLf & "- подсчет контрольных сумм папок и файлов по 5 алгоритмам;" & vbCrLf & "- создание отчёта контрольного суммирования в файлах форматов .html, .csv и .txt;" & vbCrLf & "- определение количества файлов с одинаковыми контрольными суммами;" & vbCrLf & "- поиск новых файлов в каталогах."
