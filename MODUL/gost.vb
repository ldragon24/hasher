...
Friend Class GOST
    ...
    Public Sub New(ByVal outputLenght As Integer)
        ...
        Dim utf32 = New UTF32Encoding(Not BitConverter.IsLittleEndian, True)
        Dim iv As Byte() = New Byte(utf32.GetByteCount(outputLenght) + utf32.GetPreamble().Length) {}
        Dim N As Byte() = New Byte(utf32.GetByteCount(outputLenght) + utf32.GetPreamble().Length) {}
        Dim Sigma As Byte() = New Byte(utf32.GetByteCount(outputLenght) + utf32.GetPreamble().Length) {}
    ...
    Private Function L(ByVal state As Byte()) As Byte()
        ...
        For i = 0 To 7
            ...
            Dim ResPart As Byte() = BitConverter.GetBytes(t)
    ...
    Public Function GetHashGost(ByVal message As Byte()) As Byte()
        ...
        Dim utf32 = New UTF32Encoding(Not BitConverter.IsLittleEndian, True)
        Dim iv As Byte() = New Byte(utf32.GetByteCount(message.Length) + utf32.GetPreamble().Length) {}
        Dim N As Byte() = New Byte(utf32.GetByteCount(message.Length) + utf32.GetPreamble().Length) {}
        Dim Sigma As Byte() = New Byte(utf32.GetByteCount(message.Length) + utf32.GetPreamble().Length) {}
